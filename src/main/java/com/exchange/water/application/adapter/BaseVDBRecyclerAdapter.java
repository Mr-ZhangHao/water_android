...
import com.exchange.water.application.utils.ListItemAnimator;
...
public abstract class BaseVDBRecyclerAdapter<VDB extends ViewDataBinding, T> extends
        RecyclerView.Adapter<BaseVDBRecyclerAdapter.ViewHolder<VDB>> {
